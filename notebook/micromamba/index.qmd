...
categories:
  - CLI
  - Containerization
image: ../../assets/covers/mamba-logo.png
toc: true
---
...
If you encounter an error during installation, refer to micromamba's [troublshooting page](https://mamba.readthedocs.io/en/latest/user_guide/troubleshooting.html) for a list of common errors.
...
|samtools|1.9|SAM/BAM Indexing and Manipulation|https://github.com/samtools/samtools|
...
```bash
micromamba create -n bioinfo221 # <1>
micromamba activate bioinfo221 # <2>
micromamba install -c bioconda spades quast bowtie2 gatk4 snpeff samtools # <3>
```
1. Create a micromamba environment named **bioinfo221**
2. Activate the environment
3. Install selected tools from the bioconda channel
...
dependencies: # <2>
  ...
  - samtools # <2>
```
1. A list of channels to pull packages from
2. A list of packages to be installed

::: {.column-margin}
{{< downloadthis env.yml dname="env.yml" label="Download YAML file" icon="filetype-yml" >}}
:::
