...
[Micromamba](https://mamba.readthedocs.io/en/latest/installation/micromamba-installation.html) is a package manager used to install programs in their own isolated environments. It is a standalone version of **Mamba** written purely in.
